...
## SLIDE 2: Escopo e Mapeamento de Requisitos (DRS_LES_2_2026)
...
## SLIDE 3: Regras de Negócio e Requisitos Não Funcionais
...
## SLIDE 4: Regra Crítica — Distinção entre Inativação e Exclusão
...
## SLIDE 5: Arquitetura da Solução & Modelagem de Dados
- **Stack Tecnológica:**
...
## SLIDE 6: Demonstração da Suíte de Testes Automatizados (Cypress)
...
## SLIDE 7: Conclusão & Demonstração ao Vivo
